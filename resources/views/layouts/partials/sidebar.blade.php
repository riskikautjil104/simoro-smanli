<aside class="sidebar bg-white border-end vh-100 position-fixed" style="width:220px;z-index:1000;">
  <ul class="nav flex-column pt-4">
    <li class="nav-item mb-2"><a class="nav-link fw-bold" href="/dashboard"><i class="bx bx-home"></i> Dashboard</a></li>
    <li class="nav-item mb-2"><a class="nav-link" href="/siswa"><i class="bx bx-user"></i> Siswa</a></li>
    <li class="nav-item mb-2"><a class="nav-link" href="/guru"><i class="bx bx-user-voice"></i> Guru</a></li>
