...
<aside class="sidebar-swirl">
  ...
  <div class="swirl-header">
    <div class="swirl-logo">
      <img src="<?php echo e(asset('assets/frondend/assets/img/logo.png')); ?>" alt="Logo"
  ...
  <div class="swirl-body">
    ...
    <ul class="swirl-nav">
      <li>
        <a class="swirl-link <?php echo e($active('dashboard')); ?>" href="/dashboard">
          <i class="bi bi-speedometer2"></i>
          <span>Dashboard</span>
        </a>
      </li>
      <li>
        <a class="swirl-link <?php echo e($active('admin/siswa*')); ?>" href="/admin/siswa">
          <i class="bi bi-people"></i>
          <span>Data Siswa</span>
        </a>
      </li>
      <li>
        <a class="swirl-link <?php echo e($active('admin/guru*')); ?>" href="/admin/guru">
          <i class="bi bi-person-badge"></i>
          <span>Data Guru</span>
        </a>
      </li>
      <li>
        <a class="swirl-link <?php echo e($active('admin/kelas*')); ?>" href="/admin/kelas">
          <i class="bi bi-building"></i>
          <span>Data Kelas</span>
        </a>
      </li>
      <li>
        <a class="swirl-link <?php echo e($active('admin/mapel*')); ?>" href="/admin/mapel">
    ...
    <ul class="swirl-nav">
      <li>
        <a class="swirl-link <?php echo e($active('admin/ujian*')); ?>" href="/admin/ujian">
          <i class="bi bi-file-earmark-text"></i>
          <span>Data Ujian</span>
        </a>
      </li>
      <li>
        <a class="swirl-link <?php echo e($active('admin/soal*')); ?>" href="/admin/soal">
          <i class="bi bi-question-circle"></i>
          <span>Data Soal</span>
        </a>
      </li>
      <li>
        <a class="swirl-link <?php echo e($active('admin/monitoring*')); ?>" href="/admin/monitoring">
          <i class="bi bi-tv"></i>
          <span>Monitoring Ujian</span>
        </a>
      </li>
      <li>
        <a class="swirl-link <?php echo e($active('admin/laporan*')); ?>" href="/admin/laporan">
    ...
    <ul class="swirl-nav">
      <li>
        <a class="swirl-link <?php echo e($active('profile')); ?>" href="/profile">
          <i class="bi bi-person-circle"></i>
          <span>Edit Profile</span>
        </a>
      </li>
      <li>
        <a class="swirl-link <?php echo e($active('admin/ttd*')); ?>" href="/admin/ttd">
  ...
  <div class="swirl-footer">
    ...
    <a href="/profile" class="swirl-user-card">
      ...
      <div class="swirl-user-info">
        <div class="swirl-user-name"><?php echo e(auth()->user()->name ?? 'Administrator'); ?></div>
        <div class="swirl-user-role"><?php echo e(auth()->user()->role ?? 'admin'); ?></div>
      </div>
...
</style><?php /**PATH /Users/rizkihiibrahim/Documents/simoro-smanli/resources/views/layouts/partials/verticalMenu.blade.php ENDPATH**/ ?>