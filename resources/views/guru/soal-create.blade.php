...
<div class="page-header">
    <div class="page-header-content d-flex align-items-center justify-content-between flex-wrap gap-3">
        <div>
            <h4><i class="bi bi-archive me-2"></i>Bank Soal</h4>
...
<div class="coming-soon-card">
    ...
    <h3>⚡ Coming Soon ⚡</h3>
    <p>Fitur Bank Soal sedang dalam pengembangan. Untuk sementara waktu, silakan gunakan fitur <strong>Tambah Soal Batch</strong> untuk menambahkan soal secara massal.</p>
    ...
    <div class="info-box">
        ...
        <span>Fitur Batch Soal sudah siap digunakan dan aman! Kamu bisa tambah soal sebanyak yang kamu mau kapan saja.</span>
    </div>
</div>
...
@push('scripts')
<script>
// Optional: Sweet alert untuk info tambahan
document.addEventListener('DOMContentLoaded', function() {
    console.log('Coming Soon mode - Batch Soal ready');
});
</script>
@endpush
